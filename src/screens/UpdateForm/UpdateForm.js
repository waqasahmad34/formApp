...
import { Text, View, Image, StatusBar, TouchableOpacity, ScrollView, Dimensions } from 'react-native';
			...
			<View style={{ flex: 1, backgroundColor: '#fff' }}>
				...
				<KeyboardAwareScrollView style={{ height: height }}>
					<View style={{ height: height - 160 }}>
						...
						<View style={{ flex: 1, flexDirection: 'row', marginTop: hp('4%'), marginHorizontal: '5%' }}>
							<TouchableOpacity
